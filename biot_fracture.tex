...
% The limiting factor is the representation of the heterogeneities due to fractures at the discrete level.
...
% The authors show in section 4.6 several special cases where their DFM model coincides with known models obtained by semi-discretization, omitting however the case of poroelasticity with non-void fractures.
% \newline
The poroelastic coupling terms used in \cite{boon_poro} are defined in terms of mixed-dimensional operators, namely 
%the matrix trace $\mathfrak T'$ and identity $\mathfrak T$. 
...
%This leads us to the conclusion that our model is different from the one of Boon and Nordbotten, while being physically justified as well as well-posed.
\end{remark}
}
