...
We want to 
% find the pressure fields $p:[0,T)\times\Omega_m\to\Real$ and $P:[0,T)\times\gamma\to\Real$ such that
...
In what follows we derive the integral identities $\eqref{eq:biot_weak}_{(ii)-(iii)}$.
